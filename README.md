  ...
  <script>
    ...
    <foreignObject width="100%" height="100%">
      <div xmlns="http://www.w3.org/1999/xhtml"> 
        ...
        <div class="container">
          <div class="text">
            <p class="question"><b>Q.</b> How did the mafioso kill the Node server?</p>
            <p class="answer"><b>A.</b> Tie await to it and let it async. </p>
          </div>
        </div>
      </div>
    </foreignObject>
  ...
  <script>
    ...
    <foreignObject width="100%" height="100%">
      <div xmlns="http://www.w3.org/1999/xhtml"> 
        ...
        <div class="container">
          <div class="text">
            <p class="question"><b>Q.</b> How do you tell an introverted computer scientist from an extroverted scientist?</p>
            <p class="answer"><b>A.</b> An extroverted computer scientist looks at your shoes when he talks to you. </p>
          </div>
        </div>
      </div>
    </foreignObject>
